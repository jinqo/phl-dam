...
ARMS = {
    ...
    "v2_T": ("phl_dam_v2", {"fast": True, "normalized_values": True,
                            ...
                            "d_key": 8, "d_value": 8}),
    "v2_TC": ("phl_dam_v2", {"fast": True, "normalized_values": True,
                             "use_phl": False, "d_model": 84, "num_slots": 4,
                             "d_key": 8, "d_value": 8, "copy_readout": True}),
    "v2_SC": ("phl_dam_v2", {"fast": True, "normalized_values": True,
                             "use_phl": False, "d_model": 76, "copy_readout": True}),
    "v3": ("phl_dam_v2", {"fast": True, "normalized_values": True, "use_phl": False,
                          "copy_readout": True, "key_norm_epsilon": 0.05,
                          "dnc_write_addressing": True, "d_model": 76}),
    "v3_TC": ("phl_dam_v2", {"fast": True, "normalized_values": True, "use_phl": False,
                             "copy_readout": True, "key_norm_epsilon": 0.05,
                             "dnc_write_addressing": True, "d_model": 84,
                             "num_slots": 4, "d_key": 8, "d_value": 8}),
    "v4": ("phl_dam_v2", {"fast": True, "normalized_values": True, "use_phl": False,
                          "copy_readout": True, "key_norm_epsilon": 0.05,
                          "dnc_write_addressing": True, "d_model": 76,
                          "copy_scale": 2.0, "tie_query_key": True}),
    "ntm_dnc_factorized_copy": ("ntm_dnc_factorized_copy", {}),
    "phl_dam": ("phl_dam", {}),
